...
MEDIA_CT = {
    ...
    "구글":   ["구글검색", "실적최대화", "GDN", "동영상"],
    "메타":   ["디스플레이"],
    "타불라": ["네이티브"],      # 사방넷 — 네이티브 광고 네트워크
    "사람인": ["배너"],          # 다우오피스HR — 채용포털 기업회원 대상 배너
}
PFX = {"네이버": "NV", "구글": "GG", "메타": "MT", "타불라": "TB", "사람인": "SR"}
...
CT_PERF = {
    ...
    "네이티브":   ((120, 320),  (.0020, .0060)),
    "배너":      ((300, 700),  (.0030, .0080)),
}
...
CT_CPA_MULT = {
    ...
    "네이티브": 2.00,          # 광범위 도달 → 전환 약함
    "배너": 1.30,             # 사람인 기업회원은 타겟 적합도가 높아 상대적으로 양호
}
...
SVC_MEDIA = {
    "사방넷": ({"네이버": .50, "구글": .30, "메타": .10, "타불라": .10}, .35),
    ...
    "다우오피스HR": ({"네이버": .40, "구글": .32, "메타": .08, "사람인": .20}, -.30),
